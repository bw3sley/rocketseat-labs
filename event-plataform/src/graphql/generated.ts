...
export type GetLessosBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessosBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessosBySlugDocument = gql`
    query GetLessosBySlug($slug: String) {
...
/**
 * __useGetLessosBySlugQuery__
 *
 * To run a query within a React component, call `useGetLessosBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessosBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessosBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessosBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessosBySlugQuery, GetLessosBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessosBySlugQuery, GetLessosBySlugQueryVariables>(GetLessosBySlugDocument, options);
      }
export function useGetLessosBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessosBySlugQuery, GetLessosBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessosBySlugQuery, GetLessosBySlugQueryVariables>(GetLessosBySlugDocument, options);
        }
export type GetLessosBySlugQueryHookResult = ReturnType<typeof useGetLessosBySlugQuery>;
export type GetLessosBySlugLazyQueryHookResult = ReturnType<typeof useGetLessosBySlugLazyQuery>;
export type GetLessosBySlugQueryResult = Apollo.QueryResult<GetLessosBySlugQuery, GetLessosBySlugQueryVariables>;
